...
import buildRoute, {DEFAULT_STATE as initialState, FilterBuilder, getReposFromParams} from './utils/buildRoute';
...
duck.addReducerCase(LOCATION_CHANGE, {
  reducer(state, {payload}) {
    ...
    return {
      ...state,
      milestoneTitles: query.m ? parseArray(query.m) : initialState.milestoneTitles,
